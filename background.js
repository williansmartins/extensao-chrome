...
chrome.pageAction.onClicked.addListener(function(tab) {
    chrome.tabs.executeScript(
        ...
        // {
        //  code:  
        //   "(document.evaluate(\"//label[contains(text(),'4')]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).click();" +
        //   "(document.evaluate(\"//label[contains(text(),'0')]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).click();" +
        //   "(document.evaluate(\"//label[contains(text(),'1')]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).click();" +
        //   "(document.evaluate(\"//label[contains(text(),'8')]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).click();" +
        //   "(document.evaluate(\"//label[contains(text(),'9')]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).click();" +
